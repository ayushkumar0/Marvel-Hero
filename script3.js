...
function character() {
  ...
  if (queryParameterName !== null && queryParameterName !== "") {
    ...
    document.getElementById("characterSection").innerHTML =s
...
function connection() {
  ...
  xhr.open(
    "GET",
    `https://gateway.marvel.com/v1/public/characters?${params}&ts=1&apikey=7975ba406751a9843b31c08eb9360543&hash=ba81f8fdf7e1f5233e29dc5a8d5a227a`,
    true
  );
